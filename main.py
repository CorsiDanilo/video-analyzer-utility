...
def setup_tray():
    ...
    menu = pystray.Menu(
        pystray.MenuItem(_('tray_show_hide') if _('tray_show_hide') != 'tray_show_hide' else "Mostra/Nascondi", on_show),
        pystray.MenuItem(_('tray_exit') if _('tray_exit') != 'tray_exit' else "Esci", on_quit)
    )
